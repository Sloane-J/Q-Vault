        ...
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navbar class="-mb-px max-lg:hidden">
                ...
                <flux:navbar.item 
                    ...
                    :href="route('student.papers.index')" 
                    :current="request()->routeIs('student.papers.index')" 
                    wire:navigate
                >
                    {{ __('Browse Papers') }}
                </flux:navbar.item>
                ...
                <flux:navbar.item 
                    icon="clock" 
                    :href="route('student.download.history')" 
                    :current="request()->routeIs('student.download.history')" 
                    wire:navigate
                >
                    {{ __('Download History') }}
                </flux:navbar.item>
            ...
            <flux:navbar class="me-1.5 space-x-0.5 rtl:space-x-reverse py-0!">
                <flux:tooltip :content="__('Search')" position="bottom">
                    <flux:navbar.item class="!h-10 [&>div>svg]:size-5" icon="magnifying-glass" :href="route('student.papers.search')" :label="__('Search')" />
                </flux:tooltip>
            </flux:navbar>
            ...
            <flux:dropdown position="top" align="end">
                ...
                <flux:menu>
                    ...
                    <flux:menu.radio.group>
                        <flux:menu.item :href="route('student.profile')" icon="user" wire:navigate>{{ __('Profile') }}</flux:menu.item>
