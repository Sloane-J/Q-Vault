                    ...
                    <div class="mb-8 bg-gray-50 p-4 rounded-lg">
                        ...
                        <form class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="col-span-1 md:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="text" name="search" id="search" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Search by keyword, course name, etc.">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="exam_type" name="exam_type" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                            ...
                            <div>
                                ...
                                <select id="student_type" name="student_type" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                                    <option value="">All Types</option>
                            ...
                            <div class="bg-white shadow rounded-lg overflow-hidden">
                                ...
                                <div class="border-t border-gray-200 bg-gray-50 px-4 py-3">
                                    <div class="flex justify-between">
                                        <button type="button" class="inline-flex items-center text-sm font-medium text-indigo-600 hover:text-indigo-500">
