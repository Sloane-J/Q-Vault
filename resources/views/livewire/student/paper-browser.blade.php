        ...
        @if (isset($papers) && $papers->count() > 0)
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
                @foreach ($papers as $paper)
                    <div
                        class="bg-white dark:bg-neutral-900 rounded-2xl shadow-sm border border-neutral-200 dark:border-neutral-700 overflow-hidden hover:shadow-lg transition-all duration-300 group">
                        {{-- Top Section with Icon and Year Badge --}}
                        <div
                            class="relative bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-900/30 dark:to-purple-800/30 p-8 h-56 flex items-center justify-center">
                            {{-- Year Badge --}}
                            <div class="absolute top-4 right-4">
                                <span
                                    class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-white/90 dark:bg-neutral-800/90 text-purple-700 dark:text-purple-300 shadow-sm">
                                    {{ $paper->exam_year }}
                                </span>
                            </div>
                        ...
                        <div class="p-6">
                            {{-- Course Name --}}
                            <h3
                                class="font-bold text-gray-900 dark:text-gray-100 text-lg mb-3 line-clamp-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                                {{ $paper->course_name }}
                            </h3>
