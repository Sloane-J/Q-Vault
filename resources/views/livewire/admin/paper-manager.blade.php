        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <div class="bg-gray-50 p-4 rounded-lg mb-6">
                    <h2 class="text-lg font-semibold mb-4">{{ $editMode ? 'Edit Paper' : 'Upload New Paper' }}</h2>
                    ...
                    <form wire:submit.prevent="savePaper" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            <label for="file" class="block text-sm font-medium text-gray-700">
                                {{ $editMode ? 'Replace File (Leave empty to keep current file)' : 'PDF File' }}
                            </label>
                        ...
                        <div class="md:col-span-2 flex items-center justify-end space-x-3 mt-4">
                            ...
                            <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                {{ $editMode ? 'Update Paper' : 'Upload Paper' }}
                            </button>
                        </div>
                    </form>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex space-x-2">
                                                ...
                                                <button wire:click="deletePaper({{ $paper->id }})" onclick="confirm('Are you sure you want to delete this paper?') || event.stopImmediatePropagation()" class="text-red-600 hover:text-red-900">
                                                    Delete
                                                </button>
                                            </div>
                                        </td>
