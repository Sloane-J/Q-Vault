        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-white dark:bg-neutral-800 p-4 rounded-xl shadow">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="font-semibold text-lg mb-2 text-gray-700 dark:text-gray-300">Total Papers</h3>
            ...
            <div class="bg-white dark:bg-neutral-800 p-4 rounded-xl shadow">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="font-semibold text-lg mb-2 text-gray-700 dark:text-gray-300">New This Week</h3>
            ...
            <div class="bg-white dark:bg-neutral-800 p-4 rounded-xl shadow">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="font-semibold text-lg mb-2 text-gray-700 dark:text-gray-300">Your Downloads</h3>
